...
namespace Mfm.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241022054035_RentalReturnDate")]
    partial class RentalReturnDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mfm.Domain.Entities.Rental", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Mfm.Domain.Entities.DeliveryPerson", b =>
                {
                    ...
                    b.OwnsOne("Mfm.Domain.Entities.ValueObjects.Cnpj", "Cnpj", b1 =>
                        {
                            b1.Property<string>("DeliveryPersonId")
                                .HasColumnType("text");
            ...
            modelBuilder.Entity("Mfm.Domain.Entities.Rental", b =>
                {
                    b.HasOne("Mfm.Domain.Entities.DeliveryPerson", "DeliveryPerson")
                        .WithMany("Rentals")
                        .HasForeignKey("DeliveryPersonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Mfm.Domain.Entities.Motorcycle", "Motorcycle")
                        .WithMany("Rentals")
                        .HasForeignKey("MotorcycleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.OwnsOne("Mfm.Domain.Entities.ValueObjects.RentalPeriod", "Period", b1 =>
                        {
                            ...
                            b1.Property<DateTimeOffset>("ExpectedEndDate")
                                .HasColumnType("timestamp with time zone")
